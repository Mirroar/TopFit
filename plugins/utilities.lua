-- ------------------------------------------------------------
-- Plugin for TopFit that does various tiny bits and piece
--  * show GearScore value of this set
--  * scan bank and inventory for items not recognized by TopFit
--  * scan for onUse effects
--  * import Pawn strings
-- ------------------------------------------------------------

-- ------------------------------------------------------------
--  Stuff needed:
--  TopFit:HasSet(setName)  -- takes a set name, returns <true> if a set of this name exists, <nil> otherwise
